...
if(CLI == "Yes") {
  ...
  command3 = paste0("RScript simulation_test/dual_test.R ", lambda_strong)
  ...
  ## Medium Signal
  command4 = paste0("RScript simulation_test/single_lambda_test.R ", lambda_medium)
  command5 = paste0("RScript simulation_test/single_geography_test.R ", lambda_medium)
  command6 = paste0("RScript simulation_test/dual_test.R ", lambda_medium)
  ...
  command9 = paste0("RScript simulation_test/dual_test.R ", lambda_weak)
